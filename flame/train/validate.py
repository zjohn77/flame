...
class Accuracy:
   '''Generate the model's holdout accuracy rate--by first looping over 
   each holdout batch to accumulate the # of correct predictions, 
   and then dividing by sample size.
   '''
